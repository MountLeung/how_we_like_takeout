package com.howwelike.aspect;

import com.howwelike.annotation.AutoFill;
import com.howwelike.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.howwelike.mapper.*.*(..)) && @annotation(com.howwelike.annotation.AutoFill)")
